# the method of modeling and meshing ISO Unit Cell with 
...
inner_radius_diag = 0.05279541
outer_radius_x = 0.07647705
outer_radius_y = 0.07647705
outer_radius_z = 0.07647705

inner_radius_x = 0.085
inner_radius_y = 0.085
inner_radius_z = 0.085
...
partMeshISO = model.PartFromMeshMirror(name='MeshPartISO',part=partMeshISO_1_2,
point1=(0,yDimension-outer_radius_x,zDimension-outer_radius_x),
point2=(-1,yDimension-outer_radius_x,zDimension-outer_radius_x))

ISOInst = assembly.Instance(name='ISO_Cell', part=partMeshISO, dependent=ON)
